 ...
 */
public class RetryComponentConsumer extends ScheduledPollConsumer {
    private Logger LOG = LoggerFactory.getLogger(RetryComponentConsumer.class);

    private final RetryComponentEndpoint endpoint;


    public RetryComponentConsumer(final RetryComponentEndpoint endpoint, final Processor processor) {
